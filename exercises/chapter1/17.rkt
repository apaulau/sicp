...
;; In a similar way, one can perform integer multiplication by means of repeated addition. The following multiplication
...
(check-equal? (fast-mult 2 6) 12)
(check-equal? (fast-mult 12 12) 144)
(check-equal? (fast-mult 0 12) 0)
(check-equal? (fast-mult 42 0) 0)
(check-equal? (fast-mult 42 1) 42)
